// NOTE: Copied over from Cupertino/Dialog.dart
// Only thing modified is the vertical padding for landscape mode on
// - line: 325 (24 - > 4 )
// - line: 73 ( 20 -> 10 )
...
const double _kDialogEdgePadding = 10.0;
...
class CupertinoActionSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (orientation == Orientation.portrait) {
      actionSheetWidth =
          MediaQuery.of(context).size.width - (_kActionSheetEdgeHorizontalPadding * 2);
    } else {
      actionSheetWidth =
          MediaQuery.of(context).size.height - (_kActionSheetEdgeHorizontalPadding * 2);
    }
...
class _CupertinoDialogRenderElement extends RenderObjectElement {
  ...
  void mount(Element? parent, Object? newSlot) {
    ...
    _contentElement = updateChild(
        _contentElement, dialogRenderWidget.contentSection, _AlertDialogSections.contentSection);
    _actionsElement = updateChild(
        _actionsElement, dialogRenderWidget.actionsSection, _AlertDialogSections.actionsSection);
  }
...
class _RenderCupertinoDialog extends RenderBox {
  ...
  _AlertDialogSizes performRegularLayout(
    ...
    final bool hasDivider =
        contentSection!.getMaxIntrinsicHeight(computeMaxIntrinsicWidth(0)) > 0.0 &&
...
class CupertinoDialogAction extends StatelessWidget {
  ...
  Widget _buildContentWithRegularSizingPolicy({
    ...
    final double fontSizeRatio =
        (textScaleFactor * textStyle.fontSize!) / _kDialogMinButtonFontSize;
...
class _RenderCupertinoDialogActions extends RenderBox
  ...
  void _drawButtonBackgroundsAndDividersStacked(Canvas canvas, Offset offset) {
    ...
    while (child != null) {
      ...
      accumulatingOffset +=
          (isDividerPresent ? dividerOffset : Offset.zero) + Offset(0.0, child.size.height);
